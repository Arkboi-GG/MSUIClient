...
- **systems/minimap**: ~~No interior (WMO) minimap~~ — implemented: player-cell WMO selection, portal-flooded authored tiles, black interior hard-switch, exact WMOAreaTable identity, and separate indoor zoom radii {150,120,90,60,40,25}.  ← `triage-2026-08-09/batch-systems-2.json`
