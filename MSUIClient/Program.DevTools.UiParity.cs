...
public sealed partial class GameLoop
{
    ...
    {
        if (!_config.DevTools || panel is not ("game-menu" or "options" or "keybindings" or "macro" or "tooltip" or "ui-errors" or "player-frame" or "target-frame" or "party-frame" or
