// MpqArchiveWriter.cs
//
// Managed MPQ v1 writer â€” replaces the native StormLib create/add path.
...
//     compression does not shrink it â€” SCompCompress's own rule),
...
//   * every queued file lands in both the hash and block tables â€” block count
...
namespace MSUIClient.Creator.Mpq;
...
public static class MpqArchiveWriter
{
    ...
    // [0x02][zlib-format deflate] â€” matches StormLib and the reader's ZLibStream.
