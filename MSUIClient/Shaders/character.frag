...
void main()
{
    ...
    if (uUnlit == 0)
    {
        ...
        // The 1.12 Model2 lane saturates the complete instance tint/light sum
        // before multiplying the texture. Leaving the upper side unbounded
        // lets booth key light + self-fill + carried lights turn pale weapon
        // textures into the neon sheet seen in the failed Warglaive capture.
