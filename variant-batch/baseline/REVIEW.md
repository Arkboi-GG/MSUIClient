# Variant baseline review - post 7C

Canonical post-7C baselines generated from commit `48c16dc` plus the clean W5
working tree. The pre-7C CSVs and their immutable acceptance key lists are in
`variant-batch/history/2026-07-31-pre7C/`.
...
| 7C-2a type-1 head composite | 8,889 row keys | 8,889 row keys | 0 |
