...
frame = back to the default. Chain lines are drawn in the Command View from each
member to its anchor in the state colour; the command card carries the chip.
